...
class cFingerDevice : public cGenericDevice
{
  public:
    ...
    cFingerDevice(unsigned int a_deviceNumber, int a_depthImageSizeX, int a_depthImageSizeY,
							 unsigned char * a_pDepthImage, int a_primaryDist, int a_primaryWidth);
  ...
  protected:
	  ...
	  ITDVHandsTracking m_tracking;
	  TDVHand m_firstHand;
	  TDVCameraWindowParams m_params;
	  unsigned char * m_pDepthImage;
