...
/*!
      ...
      \fn       cFinger3dofPointer::cFinger3dofPointer(cWorld* a_world,
...
*/
//===========================================================================
cFinger3dofPointer::cFinger3dofPointer(cWorld* a_world, unsigned int a_deviceNumber)
    : cGeneric3dofPointer(a_world)
{
    m_device = new cFingerDevice(a_deviceNumber);
}
...
/*!
      ...
      \fn       cFinger3dofPointer::~cFinger3dofPointer()
*/
//===========================================================================
cFinger3dofPointer::~cFinger3dofPointer()
{
}
